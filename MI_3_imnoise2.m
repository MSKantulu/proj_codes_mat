%D:\1photo_sketch_Oct_2016\CUHK_training_cropped_sketches\sketches\F2-017-01-sz1.jpg
...
%r = imnoise2('exponential',M,N,0.008,100.25);
%figure
...
for i = 1 : length(srcFiles1)
    ...
    I1 = I11{i}(:,:,3); 
    I11{i} = imadjust(I11{i},[0.0 1.0],[0.0  0.3]);%input intensity and output intensity
